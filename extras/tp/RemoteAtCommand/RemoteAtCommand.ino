...
uint8_t d5Cmd[] = { 'D', '5' };
uint8_t d5Value[] = { 0x05 };
uint8_t d5ValueLow[] = { 0x04 };

// SH + SL of your remote radio
XBeeAddress64 remoteAddress = XBeeAddress64(0x0013a200, 0x403a3c93);
...
void loop() {
  ...
  remoteAtRequest.setCommandValue(d5Value);
  remoteAtRequest.setCommandValueLength(sizeof(d5Value));
